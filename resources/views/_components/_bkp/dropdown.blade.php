<div>
    <div x-data="{ dropdownOpen: false }" class="relative my-32">
        ...
        <div x-show="dropdownOpen" class="absolute mt-2 py-2 w-48 bg-white rounded-md shadow-xl overflow-hidden z-20">
    ...
    <div x-data="{ dropdownOpen: false }">
        <div class="relative">
            ...
            <div x-show="dropdownOpen" class="absolute mt-2 py-2 w-64 bg-white rounded-md shadow-xl overflow-hidden z-20">
                <div class="py-2">
